...
@Composable
fun ListScreen(favoritesViewModel: FavoritesViewModel) {
            ...
            favorites?.let { favorites ->
                CoworkingsList(
                    ...
                    onFavoriteClicked = { id, isFavorite ->
                        if (isFavorite) favoritesViewModel.addFavorite(id = id)
                        else favoritesViewModel.removeFavorite(id = id)
                    }
                )
            }
        }
...
private fun ListScreenPreview() {
    PreviewBase {
        ListScreen(favoritesViewModel = viewModel())
    }
}
